...
class MobileContactUsPage extends StatefulWidget {
  ...
  @override
  MobileContactUsPageState createState() => MobileContactUsPageState();
}

class MobileContactUsPageState extends State<MobileContactUsPage> {
  @override
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              _buildIconText(
                  Icons.home_work, 'The Old Siam Plaza, 2nd Floor, Zone Silk.'),
              const SizedBox(height: 10),
  ...
  Widget _buildForm() {
    return Column(
      ...
      children: [
        ...
        _buildTextField(
            label: 'Query',
            hintText: 'Enter the information about which you wish to inquire',
            maxLine: 2),
      ],
    );
  }
